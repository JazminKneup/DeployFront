...
import { TextField, Button, Typography, Checkbox, FormControlLabel, Box, Modal } from '@mui/material';
...
function UserRegisterPage() {
  ...
  const [form, setForm] = useState({
    ...
    state: '',
    city: '',
    role: 'client', // Define el rol como cliente
  });
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        type="submit"
        fullWidth
        sx={{ padding: '1rem', fontSize: '1rem', marginTop: '1rem' }}
      >
        Register as User
      </Button>
